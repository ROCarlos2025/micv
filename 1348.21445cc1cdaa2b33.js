"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([[1348],{
      ...
      for (const entry of entries) {
        for (const node of entry.addedNodes) {
          ...
          if (node.nodeType === Node.ELEMENT_NODE && slots.includes(node.slot)) {
             ...
             */
            (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_1__.r)(() => watchForSlotChange(node));
            return;
          }
        }
      }
...
const getCounterText = (value, maxLength, counterFormatter) => {
  ...
  try {
    ...
    (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_2__.j)('[ion-input] - Exception in provided `counterFormatter`:', e);
    return defaultCounterText;
  }
};
...
//# sourceMappingURL=1348.21445cc1cdaa2b33.js.map