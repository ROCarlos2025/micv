"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([[7184],{
...
const Button = class {
  constructor(hostRef) {
    ...
    this.ionFocus = (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, "ionFocus", 7);
    this.ionBlur = (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, "ionBlur", 7);
    this.inItem = false;
    ...
    this.handleClick = ev => {
      ...
      } else if ((0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_1__.k)(el)) {
        this.submitForm(ev);
      }
    };
    this.onFocus = () => {
  ...
  componentWillLoad() {
    ...
    this.inheritedAttributes = (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_1__.i)(this.el);
  }
  get hasIconOnly() {
    ...
    if (typeof form === 'string') {
      ...
      if (el) {
        if (el instanceof HTMLFormElement) {
           ...
           */
          (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_0__.f)(`[ion-button] - Form with selector: "#${form}" could not be found. Verify that the id is attached to a <form> element.`, this.el);
          return null;
        }
      } else {
        /**
         ...
         */
        (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_0__.f)(`[ion-button] - Form with selector: "#${form}" could not be found. Verify that the id is correct and the form is rendered in the DOM.`, this.el);
        return null;
      }
    }
    if (form !== undefined) {
       ...
       */
      (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_0__.f)(`[ion-button] - The provided "form" element is invalid. Verify that the form is a HTMLFormElement and rendered in the DOM.`, this.el);
      return null;
    }
    /**
  ...
  render() {
    ...
    return (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_0__.d, {
    ...
    }, (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_0__.h)(TagType, Object.assign({
      ...
      onBlur: this.onBlur
    }, inheritedAttributes), (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", {
      ...
      name: "end"
    })), mode === 'md' && (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-ripple-effect", {
...
const getNamedUrl = (iconName, iconEl) => {
  ...
  try {
    return (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_0__.k)(`svg/${iconName}.svg`);
  } catch (e) {
    console.log('e', e);
    /**
...
const Icon = class {
  ...
  render() {
    ...
    return (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_0__.d, Object.assign({
    ...
    }, inheritedAttributes), this.svgContent ? (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
      class: "icon-inner",
...
//# sourceMappingURL=7184.dbf9bb579844203a.js.map