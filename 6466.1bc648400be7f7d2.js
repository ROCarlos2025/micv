"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([[6466],{
...
const startTapClick = config => {
  ...
  const setActivatedElement = (el, ev) => {
    ...
    const {
      x,
      y
    } = (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_1__.q)(ev);
    // deactivate selected
    if (activatableEle) {
...
//# sourceMappingURL=6466.1bc648400be7f7d2.js.map