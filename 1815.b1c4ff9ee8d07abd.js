"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([[1815],{
...
const warnIfValueOutOfBounds = (value, min, max) => {
  ...
  for (const val of valueArray) {
    if (min !== undefined && isBefore(val, min) || max !== undefined && isAfter(val, max)) {
      (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_0__.f)('[ion-datetime] - The value provided to ion-datetime is out of bounds.\n\n' + `Min: ${JSON.stringify(min)}\n` + `Max: ${JSON.stringify(max)}\n` + `Value: ${JSON.stringify(value)}`);
      break;
    }
  }
};
...
function parseDate(val) {
  ...
  if (parse === null) {
    ...
    (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_0__.f)(`[ion-datetime] - Unable to parse date string: ${val}. Please provide a valid ISO 8601 datetime string.`);
    return undefined;
  }
...
//# sourceMappingURL=1815.b1c4ff9ee8d07abd.js.map